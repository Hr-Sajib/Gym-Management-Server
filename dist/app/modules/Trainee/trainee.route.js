...
router.get('/:id', (0, auth_1.default)('ADMIN'), trainee_controller_1.traineeController.getTraineeById);
// Update a trainee 
router.patch('', (0, auth_1.default)('TRAINEE'), (0, validateRequest_1.default)(trainee_validation_1.updateTraineeZodSchema), trainee_controller_1.traineeController.updateTrainee);
// Delete a trainee by ID
router.delete('/:id', (0, auth_1.default)('TRAINEE'), trainee_controller_1.traineeController.deleteTrainee);
